...
namespace Web_API
{
    internal class TokenValidationHandler : DelegatingHandler
    {
        ...
        public static readonly String SECRET_MESSAGE = "ditagis.genco3";
        public static readonly int LIMIT_SESSION = 30;// DAY
        ...
        public string CreateToken(string username)
        {
            ...
            DateTime expires = DateTime.UtcNow.AddDays(LIMIT_SESSION);
